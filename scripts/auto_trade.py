...
def check_liquidate():
    ...
    for i in percent_list:
        ...
        # A 开仓
        tx = router.openPositionRouter(side=0, marginAmount=marginAmount, quoteAmount=quoteAmount,trader=SETTING["ADDRESS_USER"])
        print(tx)
        fee1 = trade_fee.get_trade_fee(tx=tx,is_liquidate=False)
